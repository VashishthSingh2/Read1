        ...
        <div class="container-fluid">
          ...
          <div class="col-xl-12">
            ...
            <div class="card mb-4">
              <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="m-0 font-weight-bold text-dark">Burners List</h5>
                    </div>
                    <div class="col">
                        <a href="add-user.html" class="btn btn-warning btn-icon-split float-right" data-toggle="modal" data-target="#addModal">
                          ...
                          <span class="text">Add Burner </span>
                        </a>
                      </div>
                  </div>
                <hr>
                 <form class="" id="" name="">
                  <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                      <input type="text" id="" name="" class="form-control" placeholder="Burner Name">
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
          ...
          <div class="card shadow mb-4">
              ...
              <div class="row listing-table">
                <div class="col-sm-12 col-md-5">Showing 1 to 10 of 57 entries</div>
