    ...
    <tr>
      ...
      <td>
        <select class="form-control" name="flame" id="flame">
            <option value="0">Flame Off</option>
            <option value="35">Flame On</option>
      ...
      <td>
      <button type="submit" formaction="${pageContext.request.contextPath}/admin/writeAndReadSteps" class="btn btn-primary">Write</button>
