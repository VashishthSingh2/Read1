...
<div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form:form method="post" id="deleteBowlForm" name="deleteBowlForm" action="${pageContext.request.contextPath}/admin/deleteBowl">
          <form:input type="hidden" path="id" id="id" class="form-control" value="${bowl.id}"/>
          ...
          <button class="btn btn-success" type="button" onclick="deleteBowl()">Yes</button>
         </form:form>
         </div>
      </div>
    </div>