...
<div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form:form method="post" id="deleteDispenseSettingsForm" name="deleteDispenseSettingsForm" action="${pageContext.request.contextPath}/admin/deleteDispenseSettings?ingredientid=${ingredientid}&dispenseSettingsId=${dispenseSettingsId}">
          <!--  form:input type="hidden" path="id" id="id" class="form-control" value="${dispenseSettingsId}"/--> 
          ...
          <button class="btn btn-success" type="button" onclick="deleteDispenseSettings()">Yes</button>
         </form:form>
         </div>
      </div>
    </div>