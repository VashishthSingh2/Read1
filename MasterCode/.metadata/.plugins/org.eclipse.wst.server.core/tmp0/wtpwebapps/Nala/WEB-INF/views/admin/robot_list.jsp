          ...
          <div class="col-xl-12">
            ...
            <div class="card mb-4">
              <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="m-0 font-weight-bold text-dark">Robots List</h5>
                    </div>
                    <div class="col">
                        <a href="add-user.html" class="btn btn-warning btn-icon-split float-right" data-toggle="modal" data-target="#addModal">
                          ...
                          <span class="text">Add Robot </span>
                        </a>
                      </div>
                  </div>
                <hr>
                 <form class="" id="" name="">
                  <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                      <input type="text" id="" name="" class="form-control" placeholder="Robot Name">
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                      <select name="" id="" class="custom-select mr-sm-2">
                            <option value="">Mapped Rack</option>
                  ...
                  <thead class="thead-dark">
                    ...
                    <tr>
                      ...
                      <td> 
                        ...
                        <span data-toggle="tooltip" data-placement="top" title="Healthy Check"><a href="robotHealthyCheck_list.jsp" class="btn btn-dark btn-circle btn-sm"><i class="fas fa-robot"></i></a></span>
