...
<html lang="en">
<head>
<title>Robot Healthy Check List</title>
          ...
          <div class="col-xl-12">
            ...
            <div class="card mb-4">
              <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="m-0 font-weight-bold text-dark">Healthy Check of <span class="text-info">Robot 1.0</span></h5>
                    </div>
                    <div class="col">
                        <a href="add-user.html" class="btn btn-warning btn-icon-split float-right" data-toggle="modal" data-target="#addModal">
                          ...
                          <span class="text">Add Healthy Check</span>
                        </a>
                      </div>
                  </div>
               </div>
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item"><a href="robot.html">Robot </a></li>
                  <li class="breadcrumb-item active" aria-current="page">Healthy Check </li>
                </ol>
              </nav>
