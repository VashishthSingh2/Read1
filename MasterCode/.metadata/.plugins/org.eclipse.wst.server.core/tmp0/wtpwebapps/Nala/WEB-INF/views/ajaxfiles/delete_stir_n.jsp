...
<div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form:form method="post" id="deleteStirForm" name="deleteStirForm" action="${pageContext.request.contextPath}/admin/deleteStir">
          <form:input type="hidden" path="id" id="id" class="form-control" value="${stir.id}"/>
          ...
          <button class="btn btn-success" type="button" onclick="deleteStir()">Yes</button>
         </form:form>
         </div>
      </div>
    </div>