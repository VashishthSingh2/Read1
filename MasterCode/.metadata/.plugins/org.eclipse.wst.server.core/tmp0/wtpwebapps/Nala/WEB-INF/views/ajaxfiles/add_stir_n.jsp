...
<div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header bg-light">
          <h5 class="modal-title text-dark">Add Stir </h5>
        ...
        <div class="modal-body">
          <form:form method="post" id="stirForm" name="stirForm" action="${pageContext.request.contextPath}/admin/saveStir" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="name">Name</label>
                        <form:input type="text" path="name"  class="form-control" placeholder="Enter Stir Name"/>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <label class="form-control-label" for="stirTypeId">Stir Type </label>
                        <select name="stirType.id" id="stirType" class="custom-select mr-sm-2">
        					...
        					<option value="${stirType.id}">${stirType.name}</option>
    						</c:forEach>                   
                        </select>
                      </div>
                    </div>
                 ...
                 <div class="row">
                    <div class="col-md-12">
                    	<button type="button" id="saveStirButton" name="saveStirButton" class="btn btn-primary my-2" data-dismiss="modal" onclick="saveStir();">Add Stir</button>
                    </div>
                 </div>
               </form:form>
        </div>
