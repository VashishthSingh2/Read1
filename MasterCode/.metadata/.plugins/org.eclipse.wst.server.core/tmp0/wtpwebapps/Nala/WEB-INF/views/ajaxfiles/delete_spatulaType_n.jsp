...
<div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form:form method="post" id="deleteSpatulaTypeForm" name="deleteSpatulaTypeForm" action="${pageContext.request.contextPath}/admin/deleteSpatulaType">
          <form:input type="hidden" path="id" id="id" class="form-control" value="${spatulaType.id}"/>
          ...
          <button class="btn btn-success" type="button" onclick="deleteSpatulaType();">Yes</button>
        </form:form>
         </div>
      </div>
</div>