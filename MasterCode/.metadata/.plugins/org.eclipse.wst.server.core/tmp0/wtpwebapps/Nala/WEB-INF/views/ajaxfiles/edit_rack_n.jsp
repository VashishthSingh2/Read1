      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="">
                  ...
                  <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="" name="" class="form-control" placeholder="Enter Rack Name" value="Rack Name 1">
                      </div>
                    </div>
                    </div>
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="" name="" class="form-control" placeholder="Enter Description" value="Rack Description placed here">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <select name="" id="" class="custom-select mr-sm-2">
                            ...
                            <option value="Section 1" selected="selected">Section 1</option>
                ...
                <div class="row">
                    <div class="col-md-12">
                    <button type="button" class="btn btn-warning my-2" data-dismiss="modal">Update Section</button>
                  </div>
                  </div>
               </form>
        </div>
