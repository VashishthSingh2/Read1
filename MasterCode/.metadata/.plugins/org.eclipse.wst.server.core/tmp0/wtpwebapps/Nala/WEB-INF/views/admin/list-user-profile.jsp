...
<body>
	...
	Show the list of User Profiles:
	<table class="c">
	...
	<tr><td><input type="text" name="name" id="name"></td> <td><input type="text" name="description" id="description"></td><td><input type="button" onclick="searchFunction()" value="Search Action"></td></tr>
		...
		<display:table name="userProfileList" requestURI="${pageContext.request.contextPath}/admin/listUserProfileAction"
	...
	<br/>
	<a href="${pageContext.request.contextPath}/admin/homeAction">Home</a> | <a href="${pageContext.request.contextPath}/admin/userProfileAction">New Profile</a>
</body>
</html>
