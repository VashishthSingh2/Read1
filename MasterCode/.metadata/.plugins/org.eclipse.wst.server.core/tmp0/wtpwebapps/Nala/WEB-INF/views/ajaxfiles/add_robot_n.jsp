  ...
  <div class="modal-dialog modal-xl" role="document">
      <div class="modal-content">
        <div class="modal-header bg-light">
          <h5 class="modal-title text-dark">Add Robot</h5>
                ...
                <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        ...
                        <input type="text" id="" name="" class="form-control" placeholder="Enter Robot Name">
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                    ...
                    <div class="col-lg-12">
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="" rows="3" placeholder="Enter Description"></textarea>
                      </div>
                    </div>
                  </div>
                     <div class="row">
                 ...
                 <div class="row">
                <div class="col-md-12">
                <button type="button" class="btn btn-primary my-2" data-dismiss="modal">Add Robot</button>
                </div>
              </div>
               </form>
        </div>
