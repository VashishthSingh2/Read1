 ...
 <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form:form method="post" id="deleteBowlTypeForm" name="deleteBowlTypeForm" action="${pageContext.request.contextPath}/admin/deleteBowlType">
          <form:input type="hidden" path="id" id="id" class="form-control" value="${bowlType.id}"/>
          ...
          <button class="btn btn-success" type="button" onclick="deleteBowlType()">Yes</button>
          </form:form>
        </div>
   </div>
</div>