 ...
 <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form:form method="post" id="deleteUtensilTypeForm" name="deleteUtensilTypeForm" action="${pageContext.request.contextPath}/admin/deleteUtensilType">
          <form:input type="hidden" path="id" id="id" class="form-control" value="${utensilType.id}"/>
          ...
          <button class="btn btn-success" type="button" onclick="deleteUtensilType()">Yes</button>
          </form:form>
        </div>
   </div>
</div>