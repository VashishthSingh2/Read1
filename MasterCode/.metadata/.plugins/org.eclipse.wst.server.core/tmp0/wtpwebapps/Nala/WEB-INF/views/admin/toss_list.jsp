      ...
      <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div class="col-xl-12">
            ...
            <div class="card mb-4">
              <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="m-0 font-weight-bold text-dark">Toss List</h5>
                    </div>
                    <div class="col">
                        <a href="add-user.html" class="btn btn-warning btn-icon-split float-right" data-toggle="modal" data-target="#addModal" onclick="getToss()">
                          <span class="icon text-white-50"><i class="fas fa-plus" aria-hidden="true"></i></span>
                          <span class="text">Add Toss </span>
                        </a>
                      </div>
                  </div>
                <hr>
                 <form method="post" class="" id="tossSearchForm" name="tossSearchForm" action="${pageContext.request.contextPath}/admin/searchToss" onsubmit="return false;">
                  <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                      <input type="text" id="tossSearchName" name="tossSearchName" class="form-control" placeholder="Enter Toss Name">
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                      <select name="tossSearchType" id="tossSearchType" class="custom-select mr-sm-2">
                            <option value="">Select Toss Type</option>
                            <c:forEach items="${tossTypeList}" var="tossType">
        					<option value="${tossType.name}">${tossType.name}</option>  
        					</c:forEach>             
                        </select>
                    </div>
                     <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                      <select name="tossSearchStatus" id="tossSearchStatus" class="custom-select mr-sm-2">
                     ...
                     <div class="col-lg-1 col-md-4 col-sm-6 mb-2">
                        <button class="btn btn-primary" type="button" id="" name="" data-toggle="tooltip" data-placement="top" title="Search" onclick="callAjx('sToss',0,1)">
          ...
          <div class="card shadow mb-4">
              <div class="card-body" id="tossGrid">
