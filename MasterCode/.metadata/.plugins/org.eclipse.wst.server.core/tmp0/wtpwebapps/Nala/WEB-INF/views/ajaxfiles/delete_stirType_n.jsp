    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form:form method="post" id="deleteStirTypeForm" name="deleteStirTypeForm" action="${pageContext.request.contextPath}/admin/deleteStirType">
          <form:input type="hidden" path="id" id="id" class="form-control" value="${stirType.id}"/>
          ...
          <button class="btn btn-success" type="button" onclick="deleteStirType()">Yes</button>
          </form:form>
         </div>
      </div>
    </div>