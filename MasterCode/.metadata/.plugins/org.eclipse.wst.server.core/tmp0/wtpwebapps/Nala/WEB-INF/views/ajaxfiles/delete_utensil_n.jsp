...
<div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form:form method="post" id="deleteUtensilForm" name="deleteUtensilForm" action="${pageContext.request.contextPath}/admin/deleteUtensil">
          <form:input type="hidden" path="id" id="id" class="form-control" value="${utensil.id}"/>
          ...
          <button class="btn btn-success" type="button" onclick="deleteUtensil()">Yes</button>
         </form:form>
         </div>
      </div>
    </div>