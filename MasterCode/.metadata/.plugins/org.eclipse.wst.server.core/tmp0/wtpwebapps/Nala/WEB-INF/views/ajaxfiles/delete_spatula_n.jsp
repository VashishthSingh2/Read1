...
<div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <form:form method="post" id="deleteSpatulaForm" name="deleteSpatulaForm" action="${pageContext.request.contextPath}/admin/deleteSpatula">
          ...
          <button class="btn btn-success" type="button" onclick="deleteSpatula()">Yes</button>
        </form:form>
         </div>
      </div>
 </div>