 ...
 <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form:form method="post" id="deleteFryerForm" name="deleteFryerForm" action="${pageContext.request.contextPath}/admin/deleteFryer">
          <form:input type="hidden" path="id" id="id" class="form-control" value="${fryer.id}"/>
          ...
          <button class="btn btn-success" type="button" onclick="deleteFryer()">Yes</button>
          </form:form>
        </div>
   </div>
</div>