...
<div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header bg-light">
         ...
         <c:set var="spatulaStatus" value="${spatula.status}" />
                       <c:choose>
                       	<c:when test = "${spatulaStatus == 'Active'}">
        ...
        <div class="modal-footer">
          ...
          <button class="btn btn-success" type="button" onclick="updateSpatulaStatus('${spatula.id}')">Yes</button>
         </div>
      </div>
</div>