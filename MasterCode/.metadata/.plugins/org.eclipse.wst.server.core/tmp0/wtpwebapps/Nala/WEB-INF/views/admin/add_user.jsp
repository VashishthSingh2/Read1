       ...
       <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
                ...
                <div class="card-body">
                <form:form method="post" action="${pageContext.request.contextPath}/admin/saveUser">
                <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group">
                        <form:label path="ssoId">SSO ID</form:label>
                        <form:input type="text" path="ssoId" class="form-control" placeholder="Enter SSO ID"></form:input>
                      </div>
                    </div>
                    <div class="col-lg-6">
                      <div class="form-group">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-6">
                     ...
                     <div class="col-lg-6">
                      <div class="form-group">
                         <form:label path="email" class="form-control-label">Last Name</form:label>
                        <form:input type="email" path="email" class="form-control" placeholder="Enter Email"></form:input>
                      </div>
                      </div>
                       <div class="col-lg-6">
                      <div class="form-group">
                         <form:label path="phone" class="form-control-label">Phone</form:label>
                        <form:input type="phone" path="phone" class="form-control" placeholder="Enter Phone"></form:input>
                      </div>
                      </div>
