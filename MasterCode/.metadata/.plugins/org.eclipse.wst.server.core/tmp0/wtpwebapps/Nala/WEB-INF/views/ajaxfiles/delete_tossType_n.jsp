 ...
 <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <form:form method="post" id="deleteTossTypeForm" name="deleteTossTypeForm" action="${pageContext.request.contextPath}/admin/deleteTossType">
          <form:input type="hidden" path="id" id="id" class="form-control" value="${tossType.id}"/>
          ...
          <button class="btn btn-success" type="button" onclick="deleteTossType()">Yes</button>
          </form:form>
        </div>
   </div>
</div>