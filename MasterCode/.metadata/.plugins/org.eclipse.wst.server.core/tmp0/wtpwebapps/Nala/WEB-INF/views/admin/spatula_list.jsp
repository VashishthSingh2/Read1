      ...
      <!-- Begin Page Content -->
        <div class="container-fluid">
          ...
          <div class="col-xl-12">
            ...
            <div class="card mb-4">
              <div class="card-body">
                  <div class="row">
                    <div class="col">
                      <h5 class="m-0 font-weight-bold text-dark">Spatula List</h5>
                    </div>
                    <div class="col">
                        <a href="#" class="btn btn-warning btn-icon-split float-right" data-toggle="modal" data-target="#addModal" onclick="getSpatula();">
                          <span class="icon text-white-50"><i class="fas fa-plus" aria-hidden="true"></i></span>
                          <span class="text">Add Spatula </span>
                        </a>
                      </div>
                  </div>
                <hr>
                  <form method="post" id="spatulaSearchForm" name="spatulaSearchForm" action="${pageContext.request.contextPath}/admin/searchSpatula" onsubmit="return false;">
                  <div class="row">
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                      <input type="text" id="spatulaSearchName" name="spatulaSearchName"  class="form-control" placeholder="Enter Spatula Name"/>
                    </div>
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                      <select name="spatulaSearchType" id="spatulaSearchType" class="custom-select mr-sm-2">
                    ...
                    <div class="col-lg-3 col-md-4 col-sm-6 mb-2">
                      <select name="spatulaSearchStatus" id="spatulaSearchStatus" class="custom-select mr-sm-2">
                     ...
                     <div class="col-lg-1 col-md-4 col-sm-6 mb-2">
                        <button class="btn btn-primary" type="button" id="" name="" data-toggle="tooltip" data-placement="top" title="Search" onclick="callAjx('sSpatula',0,1)">
          ...
          <div class="card shadow mb-4">
              <div class="card-body" id="spatulaGrid">
                ...
                <table class="table table-bordered table-hover">
                  <thead class="thead-dark">
                    ...
                    <tr>
                      <td>${spatula.id}</td>
                      <td>${spatula.name}</td>
                      <td>${spatula.spatulaType.name}</td>
                      <td> 
